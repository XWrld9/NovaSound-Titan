/**
 * useGenreTheme — NovaSound TITAN LUX v26000
 * Palette de couleurs dynamique par genre musical.
 * Utilisé par AudioPlayer, NowPlayingScreen, SongCard.
 * ────────────────────────────────────────────────────────────────
 * Genres camerounais ajoutés v26000 :
 *  Bikutsi · Makossa · Assiko · Ambas-Bay · Benskin · Mbolé
 */

const GENRE_THEMES = {

  // ════════════════════════════════════════════════════════════════
  // GENRES CAMEROUNAIS — Couleurs inspirées des cultures locales
  // ════════════════════════════════════════════════════════════════

  // Bikutsi — rouge intense, feu beti, danse frénétique
  'Bikutsi':        { primary: '#e53e3e', secondary: '#c53030', glow: 'rgba(229,62,62,0.40)',   bg: 'from-red-950/50 to-gray-950'    },
  // Makossa — or chaud, la danse camerounaise exportée dans le monde entier
  'Makossa':        { primary: '#d4a017', secondary: '#b7860b', glow: 'rgba(212,160,23,0.38)',  bg: 'from-yellow-950/45 to-gray-950' },
  // Assiko — vert forêt bassa, rythme traditionnel du littoral
  'Assiko':         { primary: '#2f855a', secondary: '#276749', glow: 'rgba(47,133,90,0.38)',   bg: 'from-green-950/45 to-gray-950'  },
  // Ambas-Bay — bleu Atlantique, musique folklorique des Yabassi
  'Ambas-Bay':      { primary: '#2b6cb0', secondary: '#2c5282', glow: 'rgba(43,108,176,0.38)', bg: 'from-blue-950/45 to-gray-950'   },
  // Benskin — violet & indigo, mélange de traditions et influences coloniales
  'Benskin':        { primary: '#6b46c1', secondary: '#553c9a', glow: 'rgba(107,70,193,0.38)', bg: 'from-purple-950/45 to-gray-950' },
  // Mbolé — orange terre cuite, rythme de la forêt équatoriale
  'Mbolé':          { primary: '#c05621', secondary: '#9c4221', glow: 'rgba(192,86,33,0.38)',  bg: 'from-orange-950/45 to-gray-950' },

  // ════════════════════════════════════════════════════════════════
  // GENRES AFRICAINS & MONDIAUX
  // ════════════════════════════════════════════════════════════════
...
// Export brut de la map pour usage statique (ExplorerPage, SongCard badges…)
export const GENRE_THEMES_MAP = GENRE_THEMES;

// Liste ordonnée (camerounais en premier)
