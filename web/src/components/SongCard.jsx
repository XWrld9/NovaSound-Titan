...
const SongCard = memo(({ song: initialSong, onPlay, isPlaying: isPlayingProp, setCurrentSong, currentSong: currentSongProp, onArchived, onDeleted }) => {
  ...
  return (
    <>
      ...
      {/* Drawer Commentaires — portal direct, hors AnimatePresence */}
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <div>
                  ...
                  <NoTranslate tag="p" className="notranslate" style={{ color: 'rgba(156,163,175,0.9)', fontSize: 12, marginTop: 1 }}>{song.title}</NoTranslate>
                </div>
              </div>
              <button
                onClick={() => setShowComments(false)}
